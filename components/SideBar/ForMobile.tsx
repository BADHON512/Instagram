                        ...
                        <div className="flex gap-x-3 items-center">
                            <div className="relative w-full max-w-sm">
                                <input
                                    type="text"
                                    placeholder="Search"
                                    className="w-full pl-10 pr-4 py-[5px] rounded-lg border bg-[#363636] focus:outline-none  outline-none border-none "
                                />
                                <IoSearchOutline
