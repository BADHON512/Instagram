...
export default function SignupPage() {
  ...
  const handleSubmit = async(e) => {
    ...
    await axios.post('/api/sign-up', signUpdata)  
    .then((res) => {
     router.push("/login")
  ...
  return (
    <div className="flex items-center flex-col justify-center min-h-screen bg-black text-white">
      <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-96">
        ...
        <p className="text-center text-gray-400 mb-4">Sign up to see photos and videos from your friends.</p>
        <button className="flex items-center justify-center w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded-md mb-4">
        ...
        <Link href="/login" className="text-center text-gray-400 mt-4">Have an account? <span className="text-blue-400 cursor-pointer">Log in</span></Link>
      </div>
